...
- **インフラ構築・運用**: Terraform による IaC、AWS（ECS / ALB / RDS 等）、NewRelic による監視設計
- **システム移行・リプレイス**: 認証基盤リプレイス（障害 0 件で 9 ヶ月運用）、TiDB 移行（約 300 万件の障害復旧を完遂）、データ移行（23,000 件を障害ゼロで移行）
- **チーム横断での改善推進**: Git 運用ルール策定（3 チーム 10 名で合意形成）、開発マニフェスト策定、モブプログラミング導入
- **技術広報・育成**: 外部登壇 6 回、未経験者 4 名の登壇サポート、勉強会設計・実施、キャッチアップ環境の整備
...
gantt
    ...
    section Dress Code
    Dress Code 株式会社                                          :active, 2025-07, 2026-03
